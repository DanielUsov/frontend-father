...
const CourseForm: React.FC = () => {
    ...
    return (
        <div id="course-section">
            <h2 onClick={() => setFormVisible(!isFormVisible)}>Создание образовательного курса</h2>
            {isFormVisible && (
                <div id="course-form" className="course-form">
                    ...
                    <input type="checkbox" id="assign-all" /> <label htmlFor="assign-all">Назначить всем сотрудникам</label>
